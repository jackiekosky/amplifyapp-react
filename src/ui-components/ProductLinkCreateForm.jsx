...
export default function ProductLinkCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setProductIDS(initialValues.productIDS);
    setErrors({});
  };
  const validations = {
    customerID: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ProductLink(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ProductLinkCreateForm")}
      {...rest}
    >
      <TextField
        label="Customer id"
